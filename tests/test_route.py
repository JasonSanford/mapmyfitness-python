...
class RouteTest(MapMyFitnessTestCase):
    ...
    @httpretty.activate
    def test_all_close_to_location_close_to_location_works(self):
        uri = self.uri_root + '/route/?field_set=detailed&close_to_location=35.555%2C-80.934&limit=40'
        content_returned = '{"_links":{"prev":[{"href":"/v7.0/route/?count=1&close_to_location=35.555,-80.934&limit=40&offset=0"}],"self":[{"href":"/v7.0/route/?count=1&close_to_location=35.555%2C-80.934&limit=40&offset=40"}],"documentation":[{"href":"https://www.mapmyapi.com/docs/Route"}],"next":[{"href":"/v7.0/route/?count=1&close_to_location=35.555,-80.934&limit=40&offset=80"}]},"_embedded":{"routes":[{"total_descent":null,"city":"Mooresville","data_source":null,"description":"","updated_datetime":"2012-07-10T14:02:56+00:00","created_datetime":"2012-07-10T14:02:56+00:00","country":"us","start_point_type":"","starting_location":{"type":"Point","coordinates":[-80.937104,35.552284]},"distance":5719.7122499416,"name":"3.55 mi Run in Mooresville on Jul 10, 2012 10:02 AM","climbs":null,"state":"NC","max_elevation":null,"postal_code":"","min_elevation":null,"_links":{"self":[{"href":"/v7.0/route/111753509/","id":"111753509"}],"user":[{"href":"kabinkley"}],"alternate":[{"href":"/v7.0/route/111753509/?format=kml&field_set=detailed","id":"111753509","name":"kml"}],"thumbnail":[{"href":"//drzetlglcbfx.cloudfront.net/routes/thumbnail/111753509?size=100x100&ts=1341928976"}],"privacy":[{"href":"/v7.0/privacy_option/3/","id":"3"}]},"points":null,"total_ascent":null}]},"total_count":1}'
        httpretty.register_uri(httpretty.GET, uri, body=content_returned, status=200)
        routes_paginator = self.mmf.route.search(close_to_location=[35.555, -80.934])
        self.assertEqual(routes_paginator.count, 1)
