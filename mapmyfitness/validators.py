...
class UserValidator(BaseValidator):
    def validate_search(self):
        ...
        if 'friends_with' not in search_kwargs or 'requested_friendship_with' not in search_kwargs or 'suggested_friends_for' not in search_kwargs:
        ...
        if 'friends_with' in search_kwargs:
            ...
            if 'suggested_friends_source' not in search_kwargs or 'suggested_friends_emails' not in search_kwargs:
